    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://bucky_med_mdt/getWarrants');
        ...
        closeMDT() {
            $.post('http://bucky_med_mdt/close', JSON.stringify({}));
        },
        getClass(element) {
        ...
        OffenderSearch() {
            if (this.offender_search) {
                ...
                $.post('http://bucky_med_mdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://bucky_med_mdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://bucky_med_mdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://bucky_med_mdt/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && this.report_new.incident) {
                $.post('http://bucky_med_mdt/submitNewReport', JSON.stringify({
        ...
        SubmitNote() {
            if (this.note_new.title && this.note_new.note) {
                $.post('http://bucky_med_mdt/submitNote', JSON.stringify({
        ...
        OpenOffenderDetailsById(charidentifier) {
            $.post('http://bucky_med_mdt/getOffender', JSON.stringify({
        ...
        DeleteSelectedReport() {
            $.post('http://bucky_med_mdt/deleteReport', JSON.stringify({
        ...
        DeleteSelectedNote() {
            $.post('http://bucky_med_mdt/deleteNote', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://bucky_med_mdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveNoteEditChanges() {
            $.post('http://bucky_med_mdt/saveNoteChanges', JSON.stringify({
                id: this.note_selected.id,
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://bucky_med_mdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://bucky_med_mdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://bucky_med_mdt/getReport', JSON.stringify({
                id: id
            }));
            this.modal = 'loading';
            return;
